...
public class XMLCheckboxPanel extends XMLPanel {
	...
	public XMLCheckboxPanel(PanelContainer pc, XMLElement owner, String title) {
		this(pc, owner, title, true, true);
	}

	public XMLCheckboxPanel(PanelContainer pc, XMLElement owner, boolean defaultValue) {
		this(pc, owner, null, true, defaultValue);
	}

	public XMLCheckboxPanel(PanelContainer pc, XMLElement owner, String title, boolean isEnabled, boolean defaultValue) {
		super(pc, owner);
		...
		JLabel jl = new JLabel(" "+ Resources.get(title == null ? owner.toName() : title));
