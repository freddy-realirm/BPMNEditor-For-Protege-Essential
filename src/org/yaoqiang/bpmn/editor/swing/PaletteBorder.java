 ...
 */
public class PaletteBorder implements Border, Serializable {
	/**
	 * 
	 */
	...
	public static PaletteBorder sharedInstance = new PaletteBorder();
	...
	public static PaletteBorder getSharedInstance() {
